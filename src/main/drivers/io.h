...
#elif defined(CH32H4)
// The lower 2 bits of mode are always 0, so just OR the speed into the lower 2 bits
#define IO_CONFIG(mode, speed) ((mode) | ((speed)))

#define IOCFG_OUT_PP         IO_CONFIG(GPIO_Mode_Out_PP, GPIO_Speed_High)
#define IOCFG_OUT_PP_25      IO_CONFIG(GPIO_Mode_Out_PP, GPIO_Speed_Very_High)
#define IOCFG_OUT_OD         IO_CONFIG(GPIO_Mode_Out_OD, GPIO_Speed_High)
#define IOCFG_AF_PP_FAST     IO_CONFIG(GPIO_Mode_AF_PP, GPIO_Speed_Very_High)
#define IOCFG_AF_PP          IO_CONFIG(GPIO_Mode_AF_PP, GPIO_Speed_High)
#define IOCFG_AF_PP_PD       IO_CONFIG(GPIO_Mode_AF_PP, GPIO_Speed_High)
#define IOCFG_AF_PP_UP       IO_CONFIG(GPIO_Mode_AF_PP, GPIO_Speed_High)
#define IOCFG_AF_OD          IO_CONFIG(GPIO_Mode_AF_OD, GPIO_Speed_High)
#define IOCFG_AF_OD_UP       IO_CONFIG(GPIO_Mode_AF_OD, GPIO_Speed_High)
#define IOCFG_IPD            IO_CONFIG(GPIO_Mode_IPD, GPIO_Speed_High)
#define IOCFG_IPU            IO_CONFIG(GPIO_Mode_IPU, GPIO_Speed_High)
#define IOCFG_IN_FLOATING    IO_CONFIG(GPIO_Mode_IN_FLOATING, GPIO_Speed_High)
#define IOCFG_IPU_25         IO_CONFIG(GPIO_Mode_IPU, GPIO_Speed_Very_High)
