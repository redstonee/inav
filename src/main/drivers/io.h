...
#define IO_CONFIG(mode, speed) (mode)

#define IOCFG_OUT_PP         IO_CONFIG(GPIO_Mode_Out_PP,       GPIO_Speed_Low)
#define IOCFG_OUT_PP_25      IO_CONFIG(GPIO_Mode_Out_PP,       GPIO_Speed_High)
#define IOCFG_OUT_OD         IO_CONFIG(GPIO_Mode_Out_OD,       GPIO_Speed_Low)
...
#define IOCFG_IPD            IO_CONFIG(GPIO_Mode_IPD,          GPIO_Speed_Low)
#define IOCFG_IPU            IO_CONFIG(GPIO_Mode_IPU,          GPIO_Speed_Low)
#define IOCFG_IN_FLOATING    IO_CONFIG(GPIO_Mode_IN_FLOATING,  GPIO_Speed_Low)
#define IOCFG_IPU_25         IO_CONFIG(GPIO_Mode_IPU,          GPIO_Speed_High)
