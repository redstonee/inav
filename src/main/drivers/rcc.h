...
#define RCC_AHB(periph) RCC_ENCODE(RCC_AHB,     RCC_HBPeriph_ ## periph)
#define RCC_AHB1(periph) RCC_ENCODE(RCC_AHB1,   RCC_HB1Periph_ ## periph)
#define RCC_AHB2(periph) RCC_ENCODE(RCC_AHB2,   RCC_HB2Periph_ ## periph)
